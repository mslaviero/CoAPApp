...
#import "CoAPApp-Bridging-Header.h"
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError * __strong *)errPtr
{
    LogTrace();
...
- (BOOL)createSockets:(NSError * __strong *)errPtr
{
    LogTrace();
